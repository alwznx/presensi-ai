## 📸 Sistem Absensi Kelas Multi-Face Berbasis AI
...
* Node.js **v18+**
* **Visual Studio C++ Build Tools** (wajib untuk Windows – agar `dlib` bisa di-install)
...
1. Masuk ke menu **Storage → New Bucket**
2. Nama bucket: `foto_absensi`
3. Aktifkan **Public Bucket**

### 🔐 Storage Policy

* Masuk ke **Storage → Policies**
...
> ⚠️ Wajib agar Python backend bisa upload foto.
...
4. Jika dikenali → status **Hadir**
5. Jika tidak → status **Unknown**

### 👨‍🏫 Mode Admin (Guru)

* Klik menu **⚙️ Admin Panel**
* Password: `admin123`
...
✨ Dibuat dengan ❤️ untuk pembelajaran **Fullstack AI**.
